package exchange.velox.commonutils;// Copyright (c) 2003-2009, Jodd Team (jodd.org). All Rights Reserved.
...
public class MimeTypes {
    ...
    public static final String MIME_APPLICATION_MSWORD_X = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
    ...
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
...

            {
                ...
                put1("docx", MIME_APPLICATION_MSWORD_X);
                put1("xls", MIME_APPLICATION_VND_MSEXCEL);
                put1("xlsx", MIME_APPLICATION_VND_MSEXCEL_X);
    ...
    public static String getMimeType(String ext) {
        String mimeType = lookupMimeTypeOrNull(ext);
        if (mimeType == null) {
     ...
     */
    public static String lookupMimeTypeOrNull(String ext) {
