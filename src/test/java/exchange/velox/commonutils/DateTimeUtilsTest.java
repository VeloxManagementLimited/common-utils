...
public class DateTimeUtilsTest {
    ...
    public void testIsBeforeVelotradeCutOffTime() {
        DateTime d = new DateTime(DateTimeUtils.nowAtHK()).withTime(14, 54, 59, 0).withZoneRetainFields(
        ...
        d = new DateTime(DateTimeUtils.nowAtHK()).withTime(14, 55, 0, 0).withZoneRetainFields(
                DateTimeZone.forTimeZone(DateTimeUtils.DEFAULT_TIMEZONE));
